...
<p align="center">
  <a href="https://github.com/IDRISSAFOWA/Portfoliomaster"><img alt="HitCounts" src="http://hits.dwyl.com/ashutosh1919/masterPortfolio.svg" /></a>
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/IDRISSAFOWA/Portfoliomaster.git
  ```
...
- If you want to design your own logo, then you can design it using `Figma`  or `Adobe Illustrator` or `Inkscape`. If you want to animate it, you can refer to `./src/components/Loader` directory which contains `js` and `css` files which animates the logo
...
- You can define your own favicon in `public/icons` directory. If you don't have a favicon, you  preview (known as description image). Run your site locally, take a screenshot and replace with `public/icons/desc.png`. Note that your screenshot should be 1280x640 for better preview.
